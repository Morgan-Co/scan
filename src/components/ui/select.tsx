...
import SelectArrow from '../../../public/select_arrow.svg'
...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		...
		className={cn(
			...
			`flex h-[43px] items-center justify-between w-full rounded-[5px] border-[2px] border-[#C7C7C7] py-[12px] pl-[22px] pr-[15.5px] text-[14px] leading-[17px]`,
			className
		)}
		{...props}
	>
