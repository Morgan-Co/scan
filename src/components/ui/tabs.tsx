...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.Trigger
		...
		className={cn(
			...
			'text-gray data-[state=active]:text-primary-turquoise transition after:content-[""] after:block after:w-full after:h-[2px] after:bg-gray data-[state=active]:after:bg-primary-turquoise after:mt-[8px]',
			className
		)}
		{...props}
	/>
